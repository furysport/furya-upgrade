...
# icad tx ibc-transfer transfer transfer channel-1 furya1t7cyvydpp4lklprksnrjy2y3xzv3q2l0n4qqvn 1000000stake --chain-id=test-1 --from=demowallet1 --keyring-backend=test -y --broadcast-mode=block --home=./data/test-1 --node=http://localhost:16657

# furyad query bank balances furya1t7cyvydpp4lklprksnrjy2y3xzv3q2l0n4qqvn 
